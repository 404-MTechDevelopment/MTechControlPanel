<template>
    <div class="main-blocks">
        <div class="main-block-1">
            <div class="identify">
                ...
                <div class="money-block">
                    <div class="info-block">
                        <i class="pi pi-credit-card" style="font-size: 2rem; color: #708090; border-radius: 10px"></i>
                        <div class="id_id-text">
                            <p class="id-text">Пополнено:</p>
                            <p class="id">{{ depostit }}</p>
                        </div>
                    </div>
                    <div class="info-block">
                    ...
                    <div class="info-block">
                        ...
                        <div class="id_id-text">
                            <p class="id-text">Дебетовые Нахкоины:</p>
        ...
        <div class="main-block-2">
            ...
            <div class="separator"></div>
            <div class="info-block">
                <i v-if="twoFaConnectStatus" class="pi pi-verified" style="font-size: 2rem; color: #708090; border-radius: 10px"></i>
                <i v-else class="pi pi-times-circle" style="font-size: 2rem; color: #708090; border-radius: 10px"></i>
                <div class="id_id-text">
            ...
            <div class="info-block">
                <i class="pi pi-telegram" style="font-size: 2rem; color: #708090; border-radius: 10px"></i>
                <div class="id_id-text">
